<?php  //[STAMP] 052499f4fe81e2843bf558710bcd8207
// phpcs:ignoreFile
namespace SprykerTest\Glue\AppPaymentBackendApi\_generated;
...
trait PaymentBackendApiTesterActions
{
     ...
     *
     *
     * @see \SprykerTest\Glue\AppPaymentBackendApi\Helper\WebhookApiHelper::mockGlueRequestWebhookMapperPlugin()
     */
    public function mockGlueRequestWebhookMapperPlugin(string $webhookDataType, ?string $transactionId = NULL, ?string $refundId = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockGlueRequestWebhookMapperPlugin', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerTest\Glue\AppPaymentBackendApi\Helper\WebhookApiHelper::mockPaymentPlatform()
     */
    public function mockPaymentPlatform(bool $webhookResponseSuccessful, ?string $paymentStatus = NULL, ?string $paymentRefundStatus = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockPaymentPlatform', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerTest\Glue\AppPaymentBackendApi\Helper\WebhookApiHelper::mockPaymentPlatformThatThrowsAnException()
     */
    public function mockPaymentPlatformThatThrowsAnException(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockPaymentPlatformThatThrowsAnException', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \SprykerTest\Glue\Testify\Helper\GlueBackendApiHelper::seeResponseCodeIs()
     */
     ...
     *
     *
     * @see \SprykerTest\Glue\Testify\Helper\GlueBackendApiHelper::seeResponseContainsErrorMessage()
     */
     ...
     *
     *
     * @see \SprykerTest\Zed\AppPayment\Helper\AppPaymentHelper::getPaymentBusinessFactory()
     */
    public function getPaymentBusinessFactory(): \Spryker\Zed\AppPayment\Business\AppPaymentBusinessFactory {
     ...
     * @see \SprykerTest\Zed\AppPayment\Helper\AppPaymentHelper::getPaymentPageRequest()
     */
