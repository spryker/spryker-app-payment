...
class AppPaymentHelper extends Module
{
    ...
    public function havePaymentOverpaidTransfer(array $seed = []): PaymentOverpaidTransfer
    {
        return (new PaymentOverpaidBuilder($seed))->build();
    }

    public function havePaymentUnderpaidTransfer(array $seed = []): PaymentUnderpaidTransfer
    {
        return (new PaymentUnderpaidBuilder($seed))->build();
    }
